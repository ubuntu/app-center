...
class GetChartRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Category>(2, _omitFieldNames ? '' : 'category', $pb.PbFieldType.OE,
        defaultOrMaker: Category.ART_AND_DESIGN,
...
class GetChartResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<Category>(3, _omitFieldNames ? '' : 'category', $pb.PbFieldType.OE,
        defaultOrMaker: Category.ART_AND_DESIGN,
        valueOf: Category.valueOf,
        enumValues: Category.values)
    ..hasRequiredFields = false;
...
class ChartData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.Rating>(2, _omitFieldNames ? '' : 'rating',
        subBuilder: $4.Rating.create)
    ..hasRequiredFields = false;
