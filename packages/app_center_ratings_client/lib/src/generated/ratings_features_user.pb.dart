...
class AuthenticateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthenticateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'ratings.features.user'), createEmptyInstance: create)
...
class AuthenticateResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthenticateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'ratings.features.user'), createEmptyInstance: create)
...
class ListMyVotesResponse extends $pb.GeneratedMessage {
  ...
  factory ListMyVotesResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListMyVotesResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListMyVotesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'ratings.features.user'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListMyVotesResponse copyWith(void Function(ListMyVotesResponse) updates) => super.copyWith((message) => updates(message as ListMyVotesResponse)) as ListMyVotesResponse;
  ...
  static $pb.PbList<ListMyVotesResponse> createRepeated() => $pb.PbList<ListMyVotesResponse>();
  @$core.pragma('dart2js:noInline')
  static ListMyVotesResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListMyVotesResponse>(create);
...
class Vote extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Vote', package: const $pb.PackageName(_omitMessageNames ? '' : 'ratings.features.user'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'snapId')
    ...
    ..aOS(5, _omitFieldNames ? '' : 'snapName')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set snapRevision($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set voteUp($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  $core.String get snapName => $_getSZ(4);
  @$pb.TagNumber(5)
  set snapName($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasSnapName() => $_has(4);
  @$pb.TagNumber(5)
  void clearSnapName() => clearField(5);
}
...
class VoteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'VoteRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'ratings.features.user'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'snapId')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'snapRevision', $pb.PbFieldType.O3)
    ..aOB(3, _omitFieldNames ? '' : 'voteUp')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VoteRequest copyWith(void Function(VoteRequest) updates) => super.copyWith((message) => updates(message as VoteRequest)) as VoteRequest;
