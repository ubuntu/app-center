...
class MockAppClient extends _i1.Mock implements _i4.AppClient {
  ...
  _i2.ResponseFuture<_i5.GetRatingResponse> getRating(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#getRating, [request], {#options: options}),
...
class MockUserClient extends _i1.Mock implements _i7.UserClient {
  ...
  _i2.ResponseFuture<_i8.AuthenticateResponse> authenticate(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#authenticate, [request], {#options: options}),
  ...
  _i2.ResponseFuture<_i9.Empty> delete(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#delete, [request], {#options: options}),
  ...
  _i2.ResponseFuture<_i9.Empty> vote(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#vote, [request], {#options: options}),
            returnValue: _FakeResponseFuture_0<_i9.Empty>(
              this,
              Invocation.method(#vote, [request], {#options: options}),
            ),
  ...
  _i2.ResponseFuture<_i8.GetSnapVotesResponse> getSnapVotes(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#getSnapVotes, [request], {#options: options}),
...
class MockChartClient extends _i1.Mock implements _i10.ChartClient {
  ...
  _i2.ResponseFuture<_i11.GetChartResponse> getChart(
    ...
    _i2.CallOptions? options,
      ...
      (super.noSuchMethod(
            Invocation.method(#getChart, [request], {#options: options}),
