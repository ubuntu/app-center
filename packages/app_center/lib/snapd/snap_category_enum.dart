...
enum SnapCategoryEnum {
  ...
  String localize(AppLocalizations l10n) => switch (this) {
    ...
    gameLaunchers => l10n.snapCategoryGameLaunchers,
    gameContentCreation => l10n.snapCategoryGameContentCreation,
  ...
  String slogan(AppLocalizations l10n) => switch (this) {
    ...
    gameLaunchers => l10n.snapCategoryGameLaunchersSlogan,
    gameContentCreation => l10n.snapCategoryGameContentCreationSlogan,
  ...
  IconData icon(bool selected) => switch (this) {
    ...
    education => selected ? YaruIcons.education_filled : YaruIcons.education,
    entertainment =>
    ...
    healthAndFitness => selected ? YaruIcons.health_filled : YaruIcons.health,
  ...
  List<Color> get bannerColors => switch (this) {
    ...
    gameLaunchers => _kBannerColors[5],
    gameContentCreation => _kBannerColors[6],
    _ => _kBannerColors[0],
  };
}
