    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Spacer(),
            SvgPicture.asset('assets/error.svg', key: const Key('error-asset'),),
            Text(
              message.title(l10n),
            ...
            Flexible(child: Text(message.body(l10n), key: const Key('error-action-body'),)),
            ...
            Row(
              ...
              children: [
                if (message.actions.contains(ErrorAction.retry))
                  OutlinedButton(
                    onPressed: onRetry,
                    key: const Key('error-actions-retry'),
                    child: Text(
